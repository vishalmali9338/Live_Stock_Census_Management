...
namespace project
{
    public partial class frm_Goat_Details : Form
    {
        ...
        private void tb_used_for_Breeding_TextChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void frm_Goat_Details_Load(object sender, EventArgs e)
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select * from Goat_Breed_Name_TB", con);
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            if (cmb_Breed_Name.Text != ""&& tb_up_6_Month.Text!="" && tb_Dry.Text!="" && tb_In_Milk.Text!="" && tb_under_1_Month_or_6_Month.Text != "" && tb_up_to_1_Year.Text != "" && tb_used_for_Breeding.Text != "" && tb_subtotal.Text != "")
            {
                ...
                SqlCommand cmd = new SqlCommand("insert into Goat_Details_TB values('" + cmb_Breed_Name.Text + "'," + tb_up_6_Month.Text + "," + tb_In_Milk.Text + "," + tb_Dry.Text + "," + tb_under_1_Month_or_6_Month.Text + "," + tb_up_to_1_Year.Text + "," + tb_used_for_Breeding.Text + "," + tb_subtotal.Text + "," + Sr_No + ")", con);

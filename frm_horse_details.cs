    ...
    public partial class frm_horse_details : Form
    {
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            if (cmb_Breed_Name.Text != "" && tb_In_Milk.Text != "" && tb_Up_2_Year.Text !="" && tb_Dry.Text !="" && tb_up_2year.Text !="" && tb_Agriculture.Text != "" && tb_Breeding.Text !="" &&  tb_subtotal.Text != "")
            {
                ...
                SqlCommand cmd = new SqlCommand("insert into Horse_Detail_TB values('" + cmb_Breed_Name.Text + "','" + tb_Up_2_Year.Text + "'," + tb_In_Milk.Text + "," + tb_Dry.Text + "," + tb_up_2year.Text + "," + tb_Agriculture.Text + "," + tb_Breeding.Text + "," + tb_subtotal.Text + "," + Sr_No + ")", con);
        ...
        private void frm_horse_details_Load(object sender, EventArgs e)
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select * from Horse_Breed_Name_TB", con);
            SqlDataAdapter sda = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            con.Close();
